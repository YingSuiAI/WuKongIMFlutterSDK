...
class MessageDB {
  ...
  dynamic getMap(WKMsg msg) {
    ...
    map['payload_committed'] = msg.payloadCommitted ? 1 : 0;
    map['original_payload_sha256'] = msg.originalPayloadSHA256;
